...
var frmProspectos = {
    ...
    InformacionGral: {
        ...
        ValidateSubSegmentosSelected: function (idSubSegmento) {
            var isValid = false;
            $("input[type=checkbox].Segmento"+idSubSegmento).each(function () {
                if ($(this).is(":checked")) {
                    isValid = true;
                    return false;
                }
        ...
        BuscadorProspectos: function (event) {
            ...
            if (result) {
                ...
                //        $.ajax({
                //            url: '/api/Catalogo?nombre=Estado',
                //            data: "",
                //            dataType: "json",
                //            type: "GET",
                //            contentType: "application/json; charset=utf-8",
        ...
        GetSubSegmentoById: function (obtenerSoloProductosMarcados) {
            ...
            console.table(subSegmento);
            return subSegmento;
        },


        //Codigo Arturo---------------------------------------------------------->>>
        //Activa la Oferta Integral.
        ...
        //GetSubSegmentosDataModel: function (subSegmento, esOfertaIntegral) {
        ...
        //Verifica si todos los checks de Servicios y Productos se encuentran seleccionados (Checkeados)
        //para activar la Oferta Integral.
    ...
    Form: {
        ValidateForm: function () {
            ...
            if (valTabInformacionGrl.IsValid && valContactos.IsValid && valArchivos.IsValid) {
                ...
                frmProspectos.Archivos.SubirImagenPerfil()
                    .then(function (response) {
                        frmProspectos.Archivos.SubirArchivo()
                            .then(function (response) {
                                prospecto = frmProspectos.Form.Values.GetValuesModel();
                                frmProspectos.Form.AddProspecto(prospecto);
                            })
                    }).catch(function (error) {
                    console.log("error");
                });
        ...
        Values: {
            ...
            GetValuesModel: function () {
                ...
                //Fotografia
                //frmProspectos.Util.Imagen.ImgBase64();
                ...
                var IDTIPOPROSPECTO = parseInt(document.getElementById('SlctTipoProspecto').options[document.getElementById('SlctTipoProspecto').selectedIndex].value);
                //Se agrega actividad por Default.



                //Estatus Prospecto.
                prospecto.estatusProspecto.id = 1;
                prospecto.estatusProspecto.idCatalogo = 26;
                prospecto.estatusProspecto.Descripcion = "Sin Contacto";
                prospecto.estatusProspecto.idPadre = 0;
        ...
        AddProspecto: function (prospecto) {
            console.log("prospecto", JSON.stringify(prospecto));
            return App.solicitarServicio({
                url: URI.Prospecto.CrearProspecto,
                metodo: "POST",
                data: prospecto
            }).then(function (response) {
                ...
                switch (parseInt(response.request.status)) {
                    case parseInt(StatusCode.OK):
                        window.sessionStorage.setItem(SessionStorageItem.IDPROSPECTO, response.data);
    ...
    Util: {
        Imagen: {
            ...
            LoadImage64: function () {
                ...
                if (Image !== '') {
                    $("#DivImg").hide();
                    $(".fileupload-preview").html('<img src="' + Image + '"/>');
